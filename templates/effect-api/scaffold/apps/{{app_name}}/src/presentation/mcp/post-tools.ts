...
import { createPost, CreatePostInput } from "@/application/use-case/create-post"
import { getPost, GetPostInput } from "@/application/use-case/get-post"
 ...
 */
export class CreatePostTool extends Schema.TaggedRequest<CreatePostTool>()(
	"CreatePostTool",
	{ payload: CreatePostInput.fields, success: Post, failure: Schema.Never },
) {}

export class GetPostTool extends Schema.TaggedRequest<GetPostTool>()(
	"GetPostTool",
	{ payload: GetPostInput.fields, success: Post, failure: Schema.Never },
) {}

export class ListPostsTool extends Schema.TaggedRequest<ListPostsTool>()(
	"ListPostsTool",
	{ payload: {}, success: Schema.Array(Post), failure: Schema.Never },
) {}
